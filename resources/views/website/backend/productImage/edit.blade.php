								...
								<div class="x_content">
									...
									<form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method="POST" action="{{ route('productImage.update',$ProductImage->id) }}" enctype="multipart/form-data">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<select class="form-control" name="productId">
													...
													<option value="{{ $product->id }}" {{ ($product->id == $ProductImage->productId) ? 'selected' : '' }}>{{ $product->productName }}</option>
													@endforeach
												</select>
											</div>
										</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="imgTitle" class="form-control @error('productName') is-danger @enderror" value="{{ $ProductImage->imgTitle }}">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
											  ...
											  <img id="previewImg" src="{{asset('/storage/')}}/{{$ProductImage->productImage}}" style="max-width: 130px;margin-top: 20px;">
