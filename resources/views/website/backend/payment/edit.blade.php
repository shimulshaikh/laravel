								...
								<div class="x_content">
									...
									<form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method="POST" action="{{ route('payment.update',$payment->id) }}">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<select class="form-control" name="customerId">
													...
													<option value="{{ $customerDetali->id }}" {{ ($customerDetali->id == $payment->customerId ) ? 'selected' : '' }}>
														{{ $customerDetali->firstName.' '.$customerDetali->lastName }}
													</option>
													@endforeach
												</select>
											</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="number" min="1" name="total" class="form-control @error('total') is-danger @enderror" value="{{ $payment->total }}">
