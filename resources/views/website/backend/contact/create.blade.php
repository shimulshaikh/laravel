		...
		<div class="x_panel">
			...
			<div class="x_content">
				...
				<div class="item form-group">
					<label class="col-form-label col-md-3 col-sm-3 label-align" for="location">Location
						...
						<div class="col-md-6 col-sm-6 ">
							<input type="text" name="location" id="location" class="form-control @error('location') is-danger @enderror" value="{{ old('location') }}">
				...
				<div class="item form-group">
					...
					<div class="col-md-6 col-sm-6 ">
						<textarea class="form-control @error('address') is-danger @enderror" name="address" id="address" rows="3">{{ old('address') }}</textarea>
				...
				<div class="item form-group">
					...
					<div class="col-md-6 col-sm-6 ">
						<input type="text" name="phone" id="phone" class="form-control @error('phone') is-danger @enderror" value="{{ old('phone') }}">
