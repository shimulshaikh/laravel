								...
								<div class="x_content">
									...
									<form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method="POST" action="{{ route('product.store') }}">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="productName" class="form-control @error('productName') is-danger @enderror" value="{{ old('productName') }}">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="number" min="1" name="price" class="form-control @error('price') is-danger @enderror" value="{{ old('price') }}">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<textarea class="form-control @error('productDesc') is-danger @enderror" name="productDesc" id="productDesc" rows="3">{{ old('productDesc') }}</textarea>
