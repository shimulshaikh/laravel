									...
									<form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method="POST" action="{{ route('contactForm.store') }}">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="name" id="name" class="form-control @error('name') is-danger @enderror" value="{{ old('name') }}">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="email" name="email" id="email" class="form-control @error('email') is-danger @enderror" value="{{ old('email') }}">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="subject" name="subject" id="subject" class="form-control @error('subject') is-danger @enderror" value="{{ old('subject') }}">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<textarea class="form-control @error('messageForm') is-danger @enderror" name="messageForm" id="messageForm" rows="3">{{ old('messageForm') }}</textarea>
