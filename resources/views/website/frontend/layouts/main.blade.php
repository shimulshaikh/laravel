                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-new-pro mb-30 text-center">
                            ...
                            <div class="product-caption">
                                <h3><a href="product_details.html">{{ $product->products->productName }}</a></h3>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-popular-items mb-50 text-center">
                            <div class="popular-img">
                                <img src="{{ asset('/storage/') }}/{{ $product->productImage }}" alt="">
                                <div class="img-cap">
                                    <a href="{{route('website.addCart',$product->products->id)}}"><span>Add to cart</span></a>
                                </div>
                            ...
                            <div class="popular-caption">
                                <h3><a href="{{route('website.addCart',$product->id)}}">{{ $product->products->productName }}</a></h3>
                                <span>$ {{ $product->products->price }}</span>
                            </div>
                        </div>
                    </div>
